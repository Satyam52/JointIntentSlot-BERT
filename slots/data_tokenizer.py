...
class TokenizeDataset(torch.utils.data.Dataset):
    def __init__(self, seqs, slot_labels, slot_word2idx, tokenizer):
        self.seqs = seqs
        self.slot_labels = slot_labels
        self.slot_word2idx = slot_word2idx
        self.tokenizer = tokenizer
        
    def align_label(self, seq, slot_label):
    ...
    def __getitem__(self, index):
        bert_input = self.align_label(self.seqs[index], self.slot_labels[index])
        return bert_input
