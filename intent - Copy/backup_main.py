...
def main(args):
    ...
    test_dataset = TokenizeDataset(
        seq_test, intent_test,  intent_word2idx,  tokenizer)
...
def evalFun(args):
    ...
    model = IntentClassification.from_pretrained("./checkpoints/massive_ep10", num_intent_labels=len(intent_labels))
